...
system=${1:-'rumbledb'}  # can be 'snowflake' or 'rumbledb'; only changes the queries
warehouse_name=${2:-'xsmall'} # 'xsmall' or 'large'
schema_name=${3:-'SSB_SF1'}  # 'adl' or 'adl_1000'

# Experiment parameters
warmups_per_query=(2 2 2 2 2 2 2 2 2)
runs_per_query=(5 5 5 5 5 5 5 5 5)
...
if [ "${system}" = "snowflake" ]; then
  QUERY_PATHS="/home/dan/data/projects/java/rumbledb-snowflake/workloads/ssb/queries/sql"
else
