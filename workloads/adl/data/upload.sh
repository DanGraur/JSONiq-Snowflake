...
table_name=${2:-'adl'}
data_path=${3:-'s3://rumbledb-snowflake-adl/SF1/'}  # can be 's3://hep-adl-ethz/hep-parquet/native/Run2012B_SingleMu-1000.parquet' or 's3://rumbledb-snowflake-adl/SF1/'
warehouse_name=${4:-'XSMALL'}
schema_name=${5:-'adl'}  # can be 'adl_1000' or adl'
database_name=${6:-'adl'}
